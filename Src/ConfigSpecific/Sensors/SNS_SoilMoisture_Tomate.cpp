/*********************************************************************
 * @file        SNS_SoilMoisture_Tomate.c
...
// *                      Includes
// ********************************************************************
#include "SNS_SoilMoisture_Tomate.h"
...
// *                      Types
// ********************************************************************
t_uint8 g_SoilMoisture_Tomate_Pin_u8;
// ********************************************************************
// *                      Prototypes
// ********************************************************************
...
t_eReturnCode SNS_SoilMoisture_Tomate_Cfg(t_uint8 f_pin, t_eArduino_PinMode f_Pinmode_e)
{
    ...
    if(Ret_e == RC_OK)
    {
        g_SoilMoisture_Tomate_Pin_u8 = f_pin;
...
t_eReturnCode SNS_SoilMoisture_Tomate_Get( t_sint16 *f_value_s16)
{
    ...
    if(Ret_e == RC_OK)
    {
        *f_value_s16 = (t_sint16)0;
        valueReceived_s16 = (t_sint16)analogRead((t_uint8)g_SoilMoisture_Tomate_Pin_u8);   
        //make % value
